...
local library = {design = "UI Library", tabs = {}, draggable = true, flags = {}, title = "ArsenalWare v1", open = false, popup = nil, instances = {}, connections = {}, options = {}, notifications = {}, tabSize = 0, theme = {}, foldername = "ArsenalWareConfig", fileext = ".txt"}
